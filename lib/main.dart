      ...
      child: MaterialApp(
        theme: ThemeData(
          ...
          textTheme: TextTheme(
            ...
            displayMedium: const TextStyle(fontSize: 40.0, fontWeight: FontWeight.bold),
            displaySmall: const TextStyle(fontSize: 38.0, fontWeight: FontWeight.bold),
            headlineMedium: const TextStyle(fontSize: 24.0, fontWeight: FontWeight.bold),
            bodyLarge: const TextStyle(fontSize: 16.0, fontWeight: FontWeight.bold),
            bodyMedium: const TextStyle(fontSize: 14.0, fontWeight: FontWeight.bold),
            labelLarge: const TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold),
          ).apply(
